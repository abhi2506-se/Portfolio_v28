...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://abhisheksingh.dev' },
  appleWebApp: {
    capable: true,
  ...
  openGraph: {
    ...
    type: 'website',
    locale: 'en_IN',
    images: [{ url: 'https://abhisheksingh.dev/image.png', width: 1200, height: 630, alt: 'Abhishek Singh — Software Engineer & DevOps Engineer' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Abhishek Singh | Software Engineer & DevOps Engineer',
    description: 'Amazon intern. React, Next.js, Docker, CI/CD. Available for full-time SWE / DevOps roles.',
    images: ['https://abhisheksingh.dev/image.png'],
...
const structuredData = {
  ...
  '@graph': [
    {
      '@type': 'Person',
      '@id': 'https://abhisheksingh.dev/#person',
      name: 'Abhishek Singh',
      url: 'https://abhisheksingh.dev',
      image: 'https://abhisheksingh.dev/image.png',
    ...
    {
      '@type': 'WebSite',
      '@id': 'https://abhisheksingh.dev/#website',
      url: 'https://abhisheksingh.dev',
      ...
      author: { '@id': 'https://abhisheksingh.dev/#person' },
      potentialAction: {
        '@type': 'SearchAction',
        target: { '@type': 'EntryPoint', urlTemplate: 'https://abhisheksingh.dev/?q={search_term_string}' },
